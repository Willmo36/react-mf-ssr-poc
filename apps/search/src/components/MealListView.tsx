...
export const MealListView: React.FC<MealListViewData> = ({
  ...
  return (
    <div className="flex justify-between items-center p-5 m-5 border-solid border-2 border-rose-400 rounded drop-shadow-sm">
      ...
      <div className="flex flex-col items-center">
        <button onClick={hBookClick} className="bg-rose-400 hover:bg-rose-300 text-white font-bold py-2 px-4 rounded-full">
